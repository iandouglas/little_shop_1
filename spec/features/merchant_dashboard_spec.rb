...
RSpec.describe 'as merchant', type: :feature do
  ...
  it 'shows me information for an order when i visit the show page for the order' do
    ...
    within '#items' do
      ...
      expect(page).to_not have_content("Quantity: pot")
      expect(page).to_not have_content("Quantity: crayon")
      expect(page).to_not have_content("Quantity: marker")
      expect(page).to_not have_content("Quantity: house")
    end
  end
end
